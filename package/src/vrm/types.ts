...
export type VRMAnimationSourceType = 'VRMC_vrm_animation' | 'VRM1' | 'VRM0' | 'custom' | 'unknown'
...
export interface VRMAnimationRetargetingOptions {
  sourceHumanoidNodeNames?: VRMHumanoidNodeNames
}
